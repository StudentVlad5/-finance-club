        ...
        <Modal onClick={e => e.stopPropagation()}>
          ...
          <Formik
            initialValues={{
              ...
              featuresEn: dataUpdate?.en?.features ? dataUpdate.en.features : [],
              ...
              featuresUa: dataUpdate?.ua?.features ? dataUpdate.ua.features : [],
              ...
              featuresDe: dataUpdate?.de?.features ? dataUpdate.de.features : [],
            }}
